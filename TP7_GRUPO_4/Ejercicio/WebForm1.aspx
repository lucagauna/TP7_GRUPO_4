<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="TP7_GRUPO_4.WebForm1" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <tr>
                    ...
                    <td class="auto-style3">Filtro:&nbsp;
                        <asp:Label ID="lblFilter" runat="server" BackColor="#333333" ForeColor="#CCCCCC" Text="Ninguno"></asp:Label>
...
<td runat="server" />
                            ...
                            <ItemTemplate>
                                <td runat="server" style="background-color:#DCDCDC; color: #000000; width: 33%; padding: 20px; vertical-align: top;">
                                    <div style="border: 1px solid #ccc; padding: 15px; border-radius: 8px;">
                                    <asp:Label ID="NombreSucursalLabel" runat="server" Text='<%# Eval("NombreSucursal") %>' />
                                    <br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    
                                    <asp:ImageButton ID="ImageButton1" runat="server" Height="300px" ImageUrl='<%# Eval("URL_Imagen_Sucursal") %>' Width="300px" ImageAlign="Middle" />
                                    <br />
                            ...
                            <LayoutTemplate>
                                <table runat="server" style="margin: 0 auto" >
                                    ...
                                    <tr runat="server">
                                        <td runat="server" style="text-align: center;background-color: #CCCCCC; font-family: Verdana, Arial, Helvetica, sans-serif;color: #000000;" class="auto-style2">
                            ...
                            <SelectedItemTemplate>
                                <td runat="server" style="background-color:#008A8C; font-weight: bold;color: #FFFFFF; width: 33%; padding: 20px; vertical-align: top;">NombreSucursal:
                                    <asp:Label ID="NombreSucursalLabel" runat="server" Text='<%# Eval("NombreSucursal") %>' />
                                    <br />URL_Imagen_Sucursal:
                                    <asp:Label ID="URL_Imagen_SucursalLabel" runat="server" Text='<%# Eval("URL_Imagen_Sucursal") %>' />
                                    <br />DescripcionSucursal:
                                    <asp:Label ID="DescripcionSucursalLabel" runat="server" style="text-align: center" Text='<%# Eval("DescripcionSucursal") %>' />
                                    <br /></td>
                            </SelectedItemTemplate>
                        </asp:ListView>
</div>
